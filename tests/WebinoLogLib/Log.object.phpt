...
$log->debug(new TestDebugMessage, [$paramOne, $paramTwo]);

$log->info(new TestInfoMessage, [$paramOne, $paramTwo]);

$log->notice(new TestNoticeMessage, [$paramOne, $paramTwo]);

$log->warning(new TestWarnMessage, [$paramOne, $paramTwo]);

$log->error(new TestErrMessage, [$paramOne, $paramTwo]);

$log->critical(new TestCritMessage, [$paramOne, $paramTwo]);

$log->alert(new TestAlertMessage, [$paramOne, $paramTwo]);

$log->emergency(new TestEmergMessage, [$paramOne, $paramTwo]);
